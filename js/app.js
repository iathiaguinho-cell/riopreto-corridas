// O listener agora engloba todo o script para garantir a execução após todos os scripts 'defer'
document.addEventListener('DOMContentLoaded', () => {
    ...
    function initializeApp() {
        ...
        try {
            ...
            document.getElementById('copa-container').innerHTML = `<p class="loading-message error">Falha ao conectar com a base de dados.</p>`;
            document.getElementById('geral-container').innerHTML = `<p class="loading-message error">Falha ao conectar com a base de dados.</p>`;
